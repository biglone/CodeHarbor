...
| T8.2 | v0.1.53 | `release: v0.1.53 [publish-npm]` |
| T8.3 | v0.1.54 | `release: v0.1.54 [publish-npm]` |
| T8.4 | v0.1.55 | `release: v0.1.55 [publish-npm]` |
| T8.5 | v0.1.56 | `release: v0.1.56 [publish-npm]` |
| T8.6 | v0.1.57 | `release: v0.1.57 [publish-npm]` |

> 说明：若中途插入热修复版本，后续版本号顺延；原则保持“每个大功能独立一个可回滚发布版本”。
