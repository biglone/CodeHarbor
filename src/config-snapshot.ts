...
export const CONFIG_SNAPSHOT_ENV_KEYS = [
  ...
  "MATRIX_PROGRESS_DELIVERY_MODE",
  "MATRIX_TYPING_TIMEOUT_MS",
  "MATRIX_NOTICE_BADGE_ENABLED",
  ...
  "RATE_LIMIT_SHARED_FALLBACK_TO_LOCAL",
  "CLI_COMPAT_MODE",
...
const envSnapshotSchema: z.ZodType<ConfigSnapshotEnv> = z
  .object({
    ...
    AUTODEV_GIT_AUTHOR_NAME: z.string().default("CodeHarbor AutoDev"),
    AUTODEV_GIT_AUTHOR_EMAIL: z.string().default("autodev@codeharbor.local"),
    ...
    AUTODEV_RUN_ARCHIVE_ENABLED: booleanStringSchema("AUTODEV_RUN_ARCHIVE_ENABLED").default("true"),
    AUTODEV_RUN_ARCHIVE_DIR: z.string().min(1).default(".codeharbor/autodev-runs"),
    AUTODEV_VALIDATION_STRICT: booleanStringSchema("AUTODEV_VALIDATION_STRICT").default("false"),
    AUTODEV_STAGE_OUTPUT_ECHO_ENABLED: booleanStringSchema("AUTODEV_STAGE_OUTPUT_ECHO_ENABLED").default("true"),
    ...
    BOT_PROFILES_AUTO_RETIRE_DEFAULT_SINGLE_INSTANCE: booleanStringSchema("BOT_PROFILES_AUTO_RETIRE_DEFAULT_SINGLE_INSTANCE").default("false"),
    ...
    MATRIX_NOTICE_BADGE_ENABLED: booleanStringSchema("MATRIX_NOTICE_BADGE_ENABLED").default("true"),
    ...
    RATE_LIMIT_SHARED_REDIS_KEY_PREFIX: z.string().min(1).default("codeharbor:rate-limit:v1"),
    RATE_LIMIT_SHARED_REDIS_COMMAND_TIMEOUT_MS: integerStringSchema("RATE_LIMIT_SHARED_REDIS_COMMAND_TIMEOUT_MS", 1).default(
      "150",
    ),
    RATE_LIMIT_SHARED_REDIS_CONCURRENCY_TTL_MS: integerStringSchema(
      "RATE_LIMIT_SHARED_REDIS_CONCURRENCY_TTL_MS",
      1,
    ).default("1800000"),
    RATE_LIMIT_SHARED_FALLBACK_TO_LOCAL: booleanStringSchema("RATE_LIMIT_SHARED_FALLBACK_TO_LOCAL").default("true"),
...
function buildSnapshotEnv(config: AppConfig): ConfigSnapshotEnv {
  ...
  return {
    ...
    AUTODEV_GIT_AUTHOR_NAME: process.env.AUTODEV_GIT_AUTHOR_NAME?.trim() || "CodeHarbor AutoDev",
    AUTODEV_GIT_AUTHOR_EMAIL: process.env.AUTODEV_GIT_AUTHOR_EMAIL?.trim() || "autodev@codeharbor.local",
    ...
    AUTODEV_RUN_ARCHIVE_ENABLED: normalizeBooleanEnv(process.env.AUTODEV_RUN_ARCHIVE_ENABLED, "true"),
    AUTODEV_RUN_ARCHIVE_DIR: process.env.AUTODEV_RUN_ARCHIVE_DIR?.trim() || ".codeharbor/autodev-runs",
    AUTODEV_VALIDATION_STRICT: normalizeBooleanEnv(process.env.AUTODEV_VALIDATION_STRICT, "false"),
    AUTODEV_STAGE_OUTPUT_ECHO_ENABLED: normalizeBooleanEnv(process.env.AUTODEV_STAGE_OUTPUT_ECHO_ENABLED, "true"),
    ...
    BOT_PROFILES_AUTO_RETIRE_DEFAULT_SINGLE_INSTANCE: String(config.botProfilesAutoRetireDefaultSingleInstance),
    ...
    MATRIX_PROGRESS_DELIVERY_MODE: config.matrixProgressDeliveryMode,
    MATRIX_TYPING_TIMEOUT_MS: String(config.matrixTypingTimeoutMs),
    MATRIX_NOTICE_BADGE_ENABLED: String(config.matrixNoticeBadgeEnabled),
    ...
    RATE_LIMIT_SHARED_MODE: config.sharedRateLimiter.mode,
    RATE_LIMIT_SHARED_REDIS_URL: config.sharedRateLimiter.redisUrl ?? "",
    RATE_LIMIT_SHARED_REDIS_KEY_PREFIX: config.sharedRateLimiter.redisKeyPrefix,
    RATE_LIMIT_SHARED_REDIS_COMMAND_TIMEOUT_MS: String(config.sharedRateLimiter.redisCommandTimeoutMs),
    RATE_LIMIT_SHARED_REDIS_CONCURRENCY_TTL_MS: String(config.sharedRateLimiter.redisConcurrencyTtlMs),
    RATE_LIMIT_SHARED_FALLBACK_TO_LOCAL: String(config.sharedRateLimiter.fallbackToLocal),
