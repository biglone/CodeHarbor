...
export const DEFAULT_AUTODEV_VALIDATION_STRICT = false;
export const DEFAULT_AUTODEV_DETAILED_PROGRESS_ENABLED = true;
export const DEFAULT_AUTODEV_STAGE_OUTPUT_ECHO_ENABLED = true;
...
export const DEFAULT_AUTODEV_SECONDARY_REVIEW_ENABLED = false;
export const DEFAULT_AUTODEV_SECONDARY_REVIEW_TARGET = "@review-guard";
export const DEFAULT_AUTODEV_SECONDARY_REVIEW_REQUIRE_GATE_PASSED = true;
